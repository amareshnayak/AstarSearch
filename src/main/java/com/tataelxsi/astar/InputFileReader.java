...
public class InputFileReader {
	...
	protected static Map<String, Coordinates> getLocationPoint(List<String> records, char target, String key) {
	...
	public static void convertGridValueToWeight(List<String> records, Utility util) {
		System.out.println("Input file for processing for best path ");
		String temp = "";
		char str = 0;
		// before conversion take place backed up for trace of path source to
		// destination
